...
def step(): #hier moet een variabele meegegeven worden anders loopt hij vast: def step(t) 
    global step_pin
...
if __name__ == '__mbin__': #bit geflipt (main=>mbin) in binary image om te voorkomen dat het programma gestart wordt
    loop()